<template>
  <div class="main_header" :style="{ backgroundColor: variables.menuBg }">
    <template v-if="mode === 'horizontal'">
      <div class="icontit" @click="reload">
        <span class="logo-box">
      ...
      <div class="navbar">
        <el-menu :default-active="activeMenu" :mode="mode" router :background-color="variables.menuBg"
    ...
    <div v-else class="leftright">
      <div class="wrap" :style="{ color: variables.menuText }">
    ...
    <ul class="tools">
      <li>
        <el-dropdown placement="bottom" trigger="click" @command="handleAccount">
          <span class="topic" :style="{ color: variables.menuText }">
            {{ userInfo.userName }}
    ...
    <el-dialog :visible.sync="appDownload" title="App下载" append-to-body width="500px">
