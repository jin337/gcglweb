...
!(function(e, t) {
  ...
  function x(e) {
    ...
    var n = (function(e, t) {
      var r = (function(e, t) {
        ...
        n = (function(e, t) {
          var r = 2 * e - 100 + 3 * t + 0.2 * t * t + 0.1 * e * t + 0.2 * p(B(e))
          return (
            (r += (2 * (20 * b(6 * e * D) + 20 * b(2 * e * D))) / 3),
  ...
  function z(e) {
    return [(e[0] * O) / F, (0.5 * Math.PI - 2 * Math.atan(Math.exp(-e[1] / F))) * O]
  }
  function T(e) {
  ...
  function ae(e, t, r) {
    ...
    var a = typeof e
    if (('string' != a && 'object' != a && m('coordinate must be an geojson or an array of position'), 'string' == a))
      try {
        e = JSON.parse(e)
      } catch (e) {
      ...
      : ((function e(t, r, n) {
          if ((void 0 === n && (n = !1), null !== t))
            for (
              ...
              f = (l = !!(s = v ? t.features[S].geometry : d ? t.geometry : t) && 'GeometryCollection' === s.type)
                ? s.geometries.length
                : 1
              for (var P = 0; P < f; P++) {
                var b = 0,
